cl_1 = 1000;
cl_2 = 2e-5;
Point(1) = {1500, 1500, -1500, cl_2};
Point(2) = {1500, 1500, 1500, cl_1};
Point(3) = {-1500, 1500, 1500, cl_1};
Point(4) = {-1500, 1500, -1500, cl_1};
Point(5) = {-1500, -1500, -1500, cl_1};
Point(6) = {-1500, -1500, 1500, cl_1};
Point(7) = {1500, -1500, 1500, cl_1};
Point(8) = {1500, -1500, -1500, cl_1};
